  ...
  <page-background>
    ...
    <b-container fluid>
      <b-row align-h="center">
        <b-col md="10" sm="12">
          <b-container fluid>
            <text-hero :header="Strings.get('hero.header', 'projects.reviews')" :subheader="Strings.get('hero.subheader', 'projects.reviews')"
            />
          </b-container>
...
export default {
  ...
  computed: {
    projectData() {
      return this.Strings.get('', 'projects.reviews');
    }
  },
  mounted() {
